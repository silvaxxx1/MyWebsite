...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    startDate: '2023',
    endDate: 'Present',
    description: 'Developed, fine-tuned, and deployed large language models (LLMs) and RAG pipelines. Optimized models for edge inference, domain-specific applications, and context-rich NLP tasks.',
    achievements: [
      'Built a RAG system integrating PostgreSQL + pgvector for vector storage and retrieval',
      'Implemented a multi-provider factory to handle closed-source models (OpenAI, Cohere) and open-source models (Hugging Face, Ollama LLaMA.cpp) for on-premise solutions',
      'Fine-tuned open-source models (LLaMA, GPT-J, Falcon, MPT) for domain-specific knowledge and various NLP applications such as summarization, classification, and entity extraction',
      'Deployed quantized LLMs (gguf, ExLlamaV2) achieving ~3× faster inference on CPU/GPU edge devices',
      'Optimized RAG and generation pipelines with LangChain and FAISS for scalable and context-aware results',
      'Improved generation quality by 20% using Chain-of-Thought (CoT) and Tree-of-Thought (ToT) prompting',
      'Reduced training and inference costs by 20–30% using PyTorch DDP, AMP, and optimized data loaders'
    ],
    technologies: [
      'Python',
      'PyTorch',
