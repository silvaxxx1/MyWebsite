export const en = {
  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        ...
        summary: 'A deep learning system fusing LSTM, Transformer, and CNN branches with cross-modal attention over NOAA satellite imagery — state-of-the-art accuracy across all benchmarks. Paired with a V2G microgrid optimization pipeline.',
  ...
  contact: {
    ...
    telegram: 'Telegram ↗',
    scheduleButton: 'Email Me Directly',
  },
